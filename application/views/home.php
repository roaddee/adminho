<div class="row">
  ...
  <div class="col-lg-6 col-xs-12">
    <div class="box box-info">
      <div class="box-header with-border">
        ...
        <h3 class="box-title">Statistik <small>Pelaksana</small></h3>
      ...
      <div class="box-body">
        <canvas id="data-pelaksana" style="height:250px"></canvas>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-6 col-xs-12">
    <div class="box box-primary">
      <div class="box-header with-border">
        <i class="fa fa-briefcase"></i>
        <h3 class="box-title">Statistik <small>Macam Jasa</small></h3>
      ...
      <div class="box-body">
        <canvas id="data-jasa" style="height:250px"></canvas>
      </div>
    </div>
  </div>
</div>
