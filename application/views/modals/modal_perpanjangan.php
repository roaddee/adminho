<div class="col-md-offset-1 col-md-12 col-md-offset-1 well">
  ...
  <form id="form-update-perpanjangan" method="POST">
      ...
      <div class='col-sm-6'>
        <div class='form-group'>
          ...
          <input type="text" class="form-control input-sm" placeholder="Nama Desa" name="nama"
            aria-describedby="sizing-addon2" value="<?= $dataPelanggan->pelanggan ?>" readonly></input>
        </div>
      </div>
      <div class='col-sm-6'>
        <div class='form-group'>
          ...
          <input type="text" class="form-control input-sm" placeholder="Kecamatan" name="kecamatan"
            aria-describedby="sizing-addon2" value="<?= $dataPelanggan->kecamatan ?>" readonly></input>
        </div>
      </div>
    </div>
      ...
      <div class='col-sm-6'>
        <div class='form-group'>
          ...
          <input type="text" class="form-control input-sm" placeholder="Nama Kabupaten" name="kabupaten"
            aria-describedby="sizing-addon2" value="<?= $dataPelanggan->kabupaten ?>" readonly></input>
        </div>
      </div>
      <div class='col-sm-6'>
        <div class='form-group'>
          ...
          <input type="text" class="form-control input-sm" placeholder="Kecamatan" name="provinsi"
            aria-describedby="sizing-addon2" value="<?= $dataPelanggan->provinsi ?>" readonly></input>
        </div>
      </div>
    </div>
      ...
      <div class='col-sm-6'>
        <div class='form-group'>
          ...
          <input type="text" class="form-control input-sm" placeholder="Nama Kontak" name="namakontak"
            aria-describedby="sizing-addon2" value="<?= $dataPelanggan->namakontak ?>" readonly></input>
        </div>
      </div>
      <div class='col-sm-6'>
        <div class='form-group'>
          ...
          <input type="text" class="form-control input-sm" placeholder="Nomor Kontak" name="nomorkontak"
            aria-describedby="sizing-addon2" value="<?= $dataPelanggan->nomorkontak ?>" readonly></input>
        </div>
      </div>
    </div>
      ...
      <div class='col-sm-6'>
        <div class='form-group'>
          ...
          <input type="url" class="form-control input-sm" placeholder="Alamat Domain" name="domain"
            aria-describedby="sizing-addon2" value="<?= $dataPelanggan->domain ?>" readonly></input>
        </div>
      </div>
      <div class='col-sm-6'>
        <div class='form-group'>
          ...
          <input type="url" class="form-control input-sm" placeholder="Alamat cPanel" name="alamat_cpanel"
            aria-describedby="sizing-addon2" value="<?= $dataPelanggan->alamat_cpanel ?>" readonly></input>
        </div>
      </div>
    </div>
      ...
      <div class='col-sm-4'>
        <div class='form-group'>
          ...
          <input type="text" class="form-control input-sm" placeholder="User Name cPanel" name="uname_cpanel"
            aria-describedby="sizing-addon2" value="<?= $dataPelanggan->uname_cpanel ?>" readonly></input>
        </div>
      </div>
      <div class='col-sm-4'>
        <div class='form-group'>
          ...
          <input type="text" class="form-control input-sm" placeholder="Password cPanel" name="pwd_cpanel"
            aria-describedby="sizing-addon2" value="<?= $dataPelanggan->pwd_cpanel ?>" readonly></input>
        </div>
      </div>
      <div class='col-sm-4'>
        <div class='form-group'>
          ...
          <input type="text" class="form-control input-sm" placeholder="Password Admin" name="pwd_admin"
            aria-describedby="sizing-addon2" value="<?= $dataPelanggan->pwd_admin ?>" readonly></input>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class='col-sm-4'>
        <div class='form-group'>
          ...
          <select name="id_jasa" class="form-control input-sm" aria-describedby="sizing-addon2" style="width: 100%" disabled>
      ...
      <div class='col-sm-4'>
        <div class='form-group'>
          ...
          <input type="text" id="input_mask_rupiah" class="form-control input-sm" name="rupiah"
            aria-describedby="sizing-addon2" value="<?= $dataPelanggan->rupiah ?>"   readonly></input>
        </div>
      </div>
      ...
      <div class='col-sm-4'>
        <div class='form-group'>
          ...
          <input type="text" class="form-control input-sm" placeholder="Keterangan" name="keterangan"
            aria-describedby="sizing-addon2" value="<?= $dataPelanggan->keterangan ?>" readonly></input>
        </div>
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <button type="submit" class="form-control btn btn-primary"> <i class="glyphicon glyphicon-ok"></i> Perpanjang</button>
      </div>
      <div class="col-sm-4"></div>
    </div>
  </form>
